...
const Photos = () => {
  ...
  useEffect(() => {
    if (window.innerWidth > 768) {
      handleGsap(greetings, greetings, 0, 300, 'top 34%', 'top -146%');
      handleGsap(circle2, circle2, 0, 300, 'top 80%', 'top -100%');
      handleGsap(circle3, circle3, 0, 300, 'top -50%', 'top -230%');
      handleGsap(titleHiking1, titleHiking1, 0, 100, 'top 30%', 'top -50%');
      handleGsap(titleHiking2, img3, 0, 200, 'top 0%', 'top -150%');
    }
