...
const Footer = () => {
    return (
        <div className='footer position-relative d-flex justify-content-center align-items-center'>
            <svg className='vw-100 position-absolute' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
